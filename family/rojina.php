<?php
require '../db.php';
$pageTitle = "Rojina Begum | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/rojina.jpg" alt="Rojina Begum" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Rojina Begum</div>
  <div class="fm-role">Spouse of Late Md Jony Hossain</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Rojina Begum</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Spouse of Late Md Jony Hossain</span></div>
