<?php
require '../db.php';
$pageTitle = "Ayat | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/ayat.jpg" alt="Ayat" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Ayat</div>
  <div class="fm-role">Daughter of Md Arif Hossain</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Ayat</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Daughter of Md Arif Hossain</span></div>
