<?php
require '../db.php';
$pageTitle = "Mehmed Mostafa | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/mehmed.jpg" alt="Mehmed Mostafa" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Mehmed Mostafa</div>
  <div class="fm-role">Son of Md Zahir Uddin Rasel</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Mehmed Mostafa</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Son of Md Zahir Uddin Rasel</span></div>
      <div class="info-row"><span class="info-label">Date of Birth</span><span class="info-value">16-MAY-2026</span></div>
