<?php
require '../db.php';
$pageTitle = "Abrar Hossain Araf | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/abrar.jpg" alt="Abrar Hossain Araf" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Abrar Hossain Araf</div>
  <div class="fm-role">Son of Md Arif Hossain</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Abrar Hossain Araf</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Son of Md Arif Hossain</span></div>
