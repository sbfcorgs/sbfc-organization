<?php
require '../db.php';
$pageTitle = "Hasina Begum | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/hasina.jpg" alt="Hasina Begum" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Hasina Begum</div>
  <div class="fm-role">Spouse of Md Mashud Rana</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Hasina Begum</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Spouse of Md Mashud Rana</span></div>
