<?php
require '../db.php';
$pageTitle = "Fatima Tur Rafiya | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/fatima.webp" alt="Fatima Tur Rafiya" class="fm-avatar" loading="lazy" decoding="async"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Fatima Tur Rafiya</div>
  <div class="fm-role">Daughter of Md Zahir Uddin Rasel</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Fatima Tur Rafiya</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Daughter of Md Zahir Uddin Rasel</span></div>
      <div class="info-row"><span class="info-label">Date of Birth</span><span class="info-value">17 April 2018</span></div>
