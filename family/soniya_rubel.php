<?php
require '../db.php';
$pageTitle = "Soniya Akter | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/soniya_rubel.jpg" alt="Soniya Akter" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Soniya Akter</div>
  <div class="fm-role">Spouse of Md Rubel Hossain</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Soniya Akter</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Spouse of Md Rubel Hossain</span></div>
    ...
    <div style="margin-top:24px;text-align:center;">
      <a href="../profiles/rubel.php" style="display:inline-flex;align-items:center;gap:8px;background:rgba(245,166,35,0.12);border:1px solid rgba(245,166,35,0.3);color:var(--accent);padding:10px 24px;border-radius:50px;text-decoration:none;font-weight:600;font-size:14px;">
        &#8592; View Md Rubel Hossain's Profile
      </a>
    </div>
  </div>
</section>
