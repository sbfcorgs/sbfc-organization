...
<section class="fm-hero">
  <img src="images/soniya_arif.jpg" alt="Soniya Akter" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Soniya Akter</div>
  <div class="fm-role">Spouse of Md Arif Hossain</div>
</section>
...
<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      ...
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Spouse of Md Arif Hossain</span></div>
