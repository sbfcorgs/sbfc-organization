<?php
require '../db.php';
$pageTitle = "Mst Khadija Akter | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/khadija.jpg" alt="Mst Khadija Akter" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Mst Khadija Akter</div>
  <div class="fm-role">Spouse of Md Zahir Uddin Rasel</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Mst Khadija Akter</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Spouse of Md Zahir Uddin Rasel</span></div>
      <div class="info-row"><span class="info-label">Date of Birth</span><span class="info-value">07 - March - 1997</span></div> 
      <div class="info-row"><span class="info-label">Children</span><span class="info-value">Girls-01, Boys-01</span></div>
      <div class="info-row"><span class="info-label">Children Name</span><span class="info-value"><a href="../family/fatima.php" style="color:var(--accent);text-decoration:none;">Fatima Tur Rafiya ↗</a> &nbsp;/&nbsp;<a href="../family/mehmed.php" style="color:var(--accent);text-decoration:none;">Mehmed Mostafa ↗</a></span></div>
      ...
      <div class="info-row"><span class="info-label">Location</span><span class="info-value">Dhaka, Bangladesh</span></div>
        
      
    </div>
    <div style="margin-top:24px;text-align:center;">
      <a href="../profiles/zahirasel.php" style="display:inline-flex;align-items:center;gap:8px;background:rgba(245,166,35,0.12);border:1px solid rgba(245,166,35,0.3);color:var(--accent);padding:10px 24px;border-radius:50px;text-decoration:none;font-weight:600;font-size:14px;">
        &#8592; View Md Zahir Uddin Rasel's Profile
      </a>
    </div>
  </div>
</section>
