<?php
require '../db.php';
$pageTitle = "Aysha | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/aysha.jpg" alt="Aysha" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Aysha</div>
  <div class="fm-role">Daughter of Md Rubel Hossain</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Aysha</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Daughter of Md Rubel Hossain</span></div>
