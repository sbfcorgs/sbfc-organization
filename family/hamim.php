<?php
require '../db.php';
$pageTitle = "Hamim | SBFC Organization";
...
<section class="fm-hero">
  <img src="images/hamim.jpg" alt="Hamim" class="fm-avatar"
    onerror="this.src='images/default_avatar.svg'">
  <div class="fm-name">Hamim</div>
  <div class="fm-role">Son of Md Mashud Rana</div>
</section>

<section>
  <div style="max-width:600px;margin:0 auto;">
    <div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:16px;padding:32px;">
      <div class="info-row"><span class="info-label">Full Name</span><span class="info-value">Hamim</span></div>
      <div class="info-row"><span class="info-label">Relation</span><span class="info-value">Son of Md Mashud Rana</span></div>
