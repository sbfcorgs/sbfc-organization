<?php
require '../db.php';
$pageTitle = "Md Mashud Rana | Founder Co-President | SBFC Organization";
$pageDescription = "Profile of Md Mashud Rana – Founder Co-President of SBFC Organization.";
include 'header.php';
?>
<style>
...
<div class="page-wrapper">
  <section class="zr-hero">
    <img src="../images/founder2.jpg" alt="Md Mashud Rana" class="zr-hero-avatar"
      onerror="this.style.display='none';document.getElementById('rana-placeholder').style.display='flex';">
    <div id="rana-placeholder" class="zr-avatar-placeholder" style="display:none;">MR</div>
    <h1 class="zr-hero-name">Md Mashud <em>Rana</em></h1>
    <div class="zr-hero-role">Founder Co-President — SBFC Organization</div>
    <p class="zr-hero-sub">A dedicated leader committed to youth development and building tomorrow's leaders today.</p>
    <div class="zr-hero-tags">
      <span class="zr-tag">Youth Development</span>
      <span class="zr-tag">Community Leadership</span>
      <span class="zr-tag">Team Building</span>
    ...
    <div class="zr-container">
      <div>
        <div class="zr-card">
          ...
          <div class="zr-info-row"><span class="zr-info-label">Role</span><span class="zr-info-value">Founder Co-President</span></div>
          ...
          <div class="zr-info-row"><span class="zr-info-label">Date of Birth</span><span class="zr-info-value">05 February 1985</span></div>
          <div class="zr-info-row"><span class="zr-info-label">Marital Status</span><span class="zr-info-value">Married</span></div>
          <div class="zr-info-row"><span class="zr-info-label">Spouse</span><span class="zr-info-value"><a href="../family/hasina.php" style="color:var(--accent);text-decoration:none;font-weight:600;">Hasina Begum ↗</a></span></div>
        <div class="zr-info-row"><span class="zr-info-label">Children </span><span class="zr-info-value">Girl-1, Boy-1</span></div>
          <div class="zr-info-row"><span class="zr-info-label">Children</span><span class="zr-info-value"><a href="../family/sumaiya.php" style="color:var(--accent);text-decoration:none;">Sumaiya Akter ↗</a> &nbsp;/&nbsp; <a href="../family/hamim.php" style="color:var(--accent);text-decoration:none;">Hamim ↗</a></span></div>
      ...
      <div>
        <div class="zr-card">
          ...
          <h2>Co-Founder &amp; Youth Advocate</h2>
          <p>Md Mashud Rana serves as the Founder Co-President of SBFC Organization, playing a pivotal role in shaping the organization's direction and culture from its earliest days.</p>
          <p>His passion lies in empowering young people — creating pathways for growth, mentorship, and meaningful contribution within the community.</p>
        </div>
        <div class="zr-notice">
          <strong>Full Profile Coming Soon</strong>
          Detailed information about Md Mashud Rana will be added shortly. Check back soon to learn more about his journey, achievements, and contributions.
        </div>
      </div>
    </div>
  </div>
